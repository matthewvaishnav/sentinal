...
console.log('  2. Check progress at: https://github.com/matthewvaishnav/sentinel/actions');
console.log(`  3. Release will appear at: https://github.com/matthewvaishnav/sentinel/releases/tag/v${newVersion}`);
console.log('');
